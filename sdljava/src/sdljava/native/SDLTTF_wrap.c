...
JNIEXPORT jlong JNICALL Java_sdljava_x_swig_SWIG_1SDLTTFJNI_TTF_1OpenFont(JNIEnv *jenv, jclass jcls, jstring jarg1, jint jarg2) {
    jlong jresult = 0 ;
    char *arg1 ;
    int arg2 ;
    TTF_Font *result;
    ...
    arg2 = (int)jarg2; 
    result = (TTF_Font *)TTF_OpenFont((char const *)arg1,arg2);
